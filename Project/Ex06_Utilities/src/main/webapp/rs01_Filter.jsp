    ...
    <body class="min-h-screen bg-[#0a0e1a] flex items-center justify-center p-8 font-[Inter]">
        <div class="w-full max-w-xl">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-slate-500 text-sm">Enter your name to test request preprocessing with Servlet Filters</p>
            </div>

            <!-- Card -->
            <div class="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-6 backdrop-blur-xl shadow-2xl">
                <form action="Second_Servlet" class="space-y-5">
                    <div class="flex flex-col gap-2">
                        <label class="text-slate-300 text-xs font-semibold uppercase tracking-wider font-medium">Your Name</label>
                        <input type="text" 
                               name="txtName" 
